...
Also see: [[Design6_ADX_Generation_Rules#Master-Page|Master page - Generation Rule]]
...
This directory is use by the [[Design6_ADC_2_0_SDK#ADCUnit|ADCUnit application]].

It should contains [[Design6_ADC_2_0_Unit_tests|unit tests xml files]].

The [[Design6_ADC_2_0_SDK#ADCUnit|unit test tool]] allows developers to fake a context (survey, properties, browser), run the rendering engine and assert against output.
...
Also see: [[Design6_ADC_2_0_Unit_tests|Unit tests topics]], [[Design6_ADC_2_0_SDK#ADCUnit|ADCUnit application]]

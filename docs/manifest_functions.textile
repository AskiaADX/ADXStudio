...
<pre><code class="css">#adc_{%= CurrentADC.InstanceId%} .item {
...
*"&lt;&lt; Manifest - Properties":manifest_properties.textile* | *"Master Page &gt;&gt;":master_page.textile*
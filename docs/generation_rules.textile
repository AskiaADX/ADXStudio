...
Except for _"text"_, _"binary"_, _"html"_ and _"flash"_ content type, all other contents accept the overload of attributes of the auto-generated tag using the "&lt;attribute&gt; element":manifest_outputs.textile#attribute.

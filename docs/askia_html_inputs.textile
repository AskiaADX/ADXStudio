...
* "Date/Time question":#datetime-question
* "Single closed question":#single-closed-question
* "Multi-coded question - classical":#multi-coded-question-classical
* "Multi-coded question - ranking":multi-coded-question-ranking
* "Multi-coded question - list":#multi-coded-question-list
...
"↑ Top of page ↑":##generate-askia-html-inputs
...
The date/time question should generate two inputs, one for the date and one for the time. It uses the format of the "Date question":#date-question and the "Time question":#time-question : *D*_XX_ and *T*_XX_
...
*"&lt;&lt; Generation Rules":generation_rules.textile* | *"Unit tests &gt;&gt;":unit_tests.textile*

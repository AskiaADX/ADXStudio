  ...
  modalDialog.addPlugin('Keyboard-Shortcuts', {
    ...
    createButtons: function (modalDialog) {
      ...
      dialogEl.innerHTML = [
        ...
        '<p><span class="KBshortcut">Ctrl + Alt + I</span>:<span class="shortcutDescription"> Open the developer tools of the main window</span></p>',
        '<p><span class="KBshortcut">Ctrl + Alt + E</span>:<span class="shortcutDescription"> Open the developer tools of the explorer</span></p>',
        '<p><span class="KBshortcut">Ctrl + Alt + W</span>:<span class="shortcutDescription"> Open the developer tools of the workspace</span></p>',
        ...
        '<p><span class="KBshortcut">Del</span>:<span class="shortcutDescription"> Remove the selection</span></p>',
        ...
        '<p><span class="KBshortcut">Ctrl + G</span>:<span class="shortcutDescription"> Next match</span></p>',
        '<p><span class="KBshortcut">Ctrl + Shift + F</span>:<span class="shortcutDescription"> Replace occurrences of a word</span></p>',
        '<p><span class="KBshortcut">Ctrl + Shift + G</span>:<span class="shortcutDescription"> Previous match</span></p>',
        ...
        '<p><span class="KBshortcut">Ctrl + Home</span>:<span class="shortcutDescription"> Go to the beginning of the page</span></p>',
        ...
        '<p><span class="KBshortcut">Shift + tab</span>:<span class="shortcutDescription"> Auto indent selected lines, or current line if nothing is selected</span></p>',
        ...
        '<p><span class="KBshortcut">Ctrl + -</span>:<span class="shortcutDescription"> Collapse current line</span></p>',
        '<p><span class="KBshortcut">Ctrl + +</span>:<span class="shortcutDescription"> Expand current line</span></p>',
